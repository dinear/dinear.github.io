    ...
    loadGLTF() {
        ...
        loader.load(
            ...
            function (gltf) {
                ...
                self.loadingBar.visible = false;//anu1:uncommented
                self.setupXR();//anu2:dont know whats the use
    ...
    loadGLTF3() {
        ...
        loader.load(
            ...
            function (image) {
                ...
                //break
                self.image = image;
                // self.space = image.scene;
                // self.jsonscene = obj;

                // gifobj.scene.position.set(0, -1.5, -1);
                // gifobj.scene.scale.set(2, 2, 2);
